...
function mascara_telefone(v){
    v=v.replace(/\D/g,"")                 //Remove tudo o que não é digitado
...
//a função abaixo peguei no próprio site referenciado lá em cima
function cpf(v){
...
//-----x-----//a função acima peguei no próprio site referenciado lá em cima
...
//eu criando máscara para matrícula
function mat(v){
    v=v.replace(/\D/g,"")                    //Remove tudo o que não é dígito
    v=v.replace(/(\d{3})(\d)/,"$1.$2")       //Coloca um ponto entre o terceiro e o quarto dígitos
                                             //de novo (para o segundo bloco de números)
